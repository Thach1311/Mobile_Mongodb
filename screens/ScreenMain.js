           ...
           <ScrollView style={{width:'100%',height:'100%'}}>
                <View style={styles.header}>
                        ...
                        <View style={[styles.flexCustom,{justifyContent:'space-between',marginTop:30}]}>
                            <View style={styles.flexCustom}>
                                <Image style={styles.avatar}  source={require("../assets/baiTH4/avt.jpg")}></Image>
                                <View>
               ...
               <View style={styles.footer}>
                 ...
                 <TouchableOpacity style={styles.footerItem} onPress={()=>navigation.navigate("ProfileScreen", { userId })}>
